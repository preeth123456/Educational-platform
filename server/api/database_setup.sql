...
CREATE DATABASE IF NOT EXISTS eduyata_db;
USE eduyata_db;
...
CREATE TABLE IF NOT EXISTS students (
    ...
    mobile_self VARCHAR(15),
    mobile_father VARCHAR(15),
    mobile_mother VARCHAR(15),
    class VARCHAR(255),
    board VARCHAR(255),
...
CREATE INDEX idx_email ON students(mobile_self);
...
CREATE INDEX idx_enrollment_course ON student_enrollments(course_id);
...
INSERT INTO teachers (teacher_id, name, email, phone, subject, qualification, experience_years, password_hash) VALUES
...
INSERT INTO courses (course_id, title, description, instructor_id, category, level, duration_hours, price, thumbnail_url, is_published) VALUES
