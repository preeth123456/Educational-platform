-- Run this SQL script in your MySQL/MariaDB database to create the tables
...
-- Insert Classes Data (1-12 for all boards)
...
-- Insert Sample Subjects (CBSE Classes 1-12)
...
-- Class 11-12 CBSE
(11, 'English Core', 'ENG11', TRUE), (11, 'Mathematics', 'MATH11', FALSE), (11, 'Physics', 'PHY11', FALSE), (11, 'Chemistry', 'CHEM11', FALSE), (11, 'Biology', 'BIO11', FALSE),
(12, 'English Core', 'ENG12', TRUE), (12, 'Mathematics', 'MATH12', FALSE), (12, 'Physics', 'PHY12', FALSE), (12, 'Chemistry', 'CHEM12', FALSE), (12, 'Biology', 'BIO12', FALSE);
...
(1, 'Properties of Real Numbers', 'https://youtube.com/watch?v=sample2', 'Commutative, associative properties', 'video'),
(2, 'Euclids Division Algorithm', 'https://youtube.com/watch?v=sample3', 'Step by step explanation', 'video'),
(3, 'Definition of Polynomials', 'https://youtube.com/watch?v=sample4', 'Understanding polynomial expressions', 'video'),
(4, 'Finding Zeros Graphically', 'https://youtube.com/watch?v=sample5', 'Using graphs to find zeros', 'video'),
(5, 'Introduction to Linear Equations', 'https://youtube.com/watch?v=sample6', 'Basic concepts of linear equations', 'video');
