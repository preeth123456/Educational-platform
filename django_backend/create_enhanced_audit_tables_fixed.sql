-- Enhanced Forensic-Grade Audit System Schema (MariaDB Compatible)
...
CREATE TABLE IF NOT EXISTS policy_changes_log (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
-- Data exports log
CREATE TABLE IF NOT EXISTS data_exports_log (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
